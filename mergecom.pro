...
#                                        The length of each AE title can not exceed 16 characters.
#                                        Example: 
...
#    ALLOW_LIBRARY_EXCEPTION_HANDLER    Allow to use Mergecom Toolkit internal exception handler,
#                                       it is No by default.
#    ALLOW_EMPTY_PDV_LENGTH             If No, the toolkit will not allow sending and receiving
#                                        of PDVs of zero length (as is required by the DICOM Standard).
#                                        Default is Yes 
...
#                                        Merge DICOM Toolkit implementation.
...
#
# Uncompressed Audio/Video Transfer Syntaxes
...
LICENSE                              = xxxx-xxxx-xxxx-xxxx //add license here
IMPLEMENTATION_CLASS_UID             = 2.16.840.1
IMPLEMENTATION_VERSION               = MergeCOM3_5_11_0
...
HEVC_H265_MP_LEVEL_5_1_SYNTAX           = 1.2.840.10008.1.2.4.107
HEVC_H265_M10P_LEVEL_5_1_SYNTAX         = 1.2.840.10008.1.2.4.108

SMPTE_ST_2110_20_UNCOMPRESSED_PROGRESSIVE_ACTIVE_VIDEO_SYNTAX = 1.2.840.10008.1.2.7.1
SMPTE_ST_2110_20_UNCOMPRESSED_INTERLACED_ACTIVE_VIDEO_SYNTAX  = 1.2.840.10008.1.2.7.2
SMPTE_ST_2110_30_PCM_DIGITAL_AUDIO_SYNTAX                     = 1.2.840.10008.1.2.7.3
...
#    CALCULATE_DEFINED_LENGTH_FOR_CB        If the parameter is set to No, the undefined
#                                            length will be passed as is to the callback function.
#                                            If the parameter value is Yes, the toolkit will
#                                            calculate the actual value of the data length before
...
DICTIONARY_FILE                         = C:\Users\rahulaggrawal\Downloads\mc3_w64_5110_008-91208\mc3msg\mrgcom3.dct
MSG_INFO_FILE                           = C:\Users\rahulaggrawal\Downloads\mc3_w64_5110_008-91208\mc3msg\mrgcom3.msg
TEMP_FILE_DIRECTORY                     = .
PEGASUS_OPCODE_PATH                     = .
...
COMPRESSION_LIBRARY_TO_USE              = PEGASUS
